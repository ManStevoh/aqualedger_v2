...
export default function CrmSegmentsPage() {
  const meta = useDashboardPageMeta({ title: 'Customer segmentation', description: 'Champion · Loyal · New · At risk · Lost — auto-assigned from order history' })
  ...
  return (
    <DashboardPageLayout title={meta.title} description={meta.description} breadcrumbs={meta.breadcrumbs} actions={<><Button onClick={computeRfm}>Run RFM analysis</Button></>}>
