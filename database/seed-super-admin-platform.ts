...
const PLAN_ASSIGNMENTS: Record<string, { plan: string; status: string }> = {
  ...
  kilifiprocess: { plan: 'professional', status: 'active' },
  mombasamarine: { plan: 'enterprise', status: 'active' },
  indianexport: { plan: 'enterprise', status: 'active' },
  seabreezegrill: { plan: 'professional', status: 'active' },
  swahililogistics: { plan: 'professional', status: 'active' },
  victoriatilapia: { plan: 'starter', status: 'active' },
  dungaoperators: { plan: 'starter', status: 'active' },
  homabayfresh: { plan: 'starter', status: 'active' },
  naivashacold: { plan: 'professional', status: 'active' },
  watamuenterprises: { plan: 'starter', status: 'active' },
  shimonicatch: { plan: 'starter', status: 'active' },
  malindihub: { plan: 'professional', status: 'active' },
  dianirestaurant: { plan: 'trial', status: 'active' },
  kizingitinifleet: { plan: 'trial', status: 'active' },
  pwanalogistics: { plan: 'starter', status: 'active' },
  nairobiwholesale: { plan: 'enterprise', status: 'active' },
  turkanaoperations: { plan: 'trial', status: 'suspended' },
