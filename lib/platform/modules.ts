...
export const ERP_MODULES: ErpModule[] = [
  ...
  },
  {
    ...
    nav: [
      ...
      { title: 'BMU Manager', href: '/dashboard/bmu', permission: 'fishing.bmu.read', icon: Building2 },
      { title: 'Catch Quotas', href: '/dashboard/fishing/quotas', permission: 'fishing.quotas.read', icon: Scale },
      { title: 'Vessel Insurance', href: '/dashboard/risk/insurance', permission: 'risk.insurance.read', icon: Shield },
      ...
      { title: 'Export Compliance', href: '/dashboard/export/documents', permission: 'export.documents.read', icon: FileCheck },
  ...
  },
  {
    ...
    nav: [
      ...
      { title: 'Sales Analytics', href: '/dashboard/commerce/sales', permission: 'commerce.orders.read', icon: TrendingUp },
      { title: 'Payouts', href: '/dashboard/commerce/payouts', permission: 'commerce.payouts.read', icon: Wallet },
      { title: 'Returns & Refunds', href: '/dashboard/commerce/returns', permission: 'commerce.orders.read', icon: PackageCheck },
  ...
  },
  {
    ...
    nav: [
      ...
      { title: 'Traceability Lots', href: '/dashboard/inventory/traceability', permission: 'inventory.traceability.read', icon: ScanLine },
